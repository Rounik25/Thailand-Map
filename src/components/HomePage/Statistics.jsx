...
export function Statistics({ rows }) {
    ...
    return (
        <div className="w-full h-full min-h-0 min-w-0 overflow-hidden flex rounded-xl p-5 min-h-0 min-w-0 overflow-hidden">
            <div className="flex w-1/3 h-full bg-white p-5 mr-5 justify-evenly shadow-xl rounded-xl min-h-0 min-w-0 overflow-hidden">
                <div className="flex flex-col text-center items-center justify-center min-h-0 min-w-0 overflow-hidden">
                ...
                <div className="flex flex-col">
                    <div className="flex h-1/2 items-center justify-between text-center min-h-0 min-w-0 overflow-hidden">
