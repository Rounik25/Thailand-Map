    ...
    return (
        <div className="h-full w-full shadow-lg border-2 border-slate-300 rounded-lg">
            <Filters
                ...
                renderCustomFilters={({ selected, setSelected }) => {
                    ...
                    return (
                        <>
                            ...
                            <Select
                                ...
                                onChange={(nextCol2) => {
                                    const mappedCol1 =
                                        nextCol2 === "All" ? selected[COL1_ID] : col2ToCol1.get(nextCol2) ?? selected[COL1_ID];
                ...
                renderLegend={() => (
                    <>
                        <EntityLegend />
                        <TechnologyLegend selectedTechnology={value?.technology} />
                    </>
                )}
                renderFooter={() => (
